...
#SBATCH -J entropy_tf_prefill
#SBATCH -p gpu
#SBATCH --gpus 1
#SBATCH -t 05:00:00
#SBATCH -o logs/entropy_tf_prefill_%j.out
#SBATCH -e logs/entropy_tf_prefill_%j.err
...
OUT=./results/entropy_analysis/llma31_8b/longbench/narrativeqa/tf_prefill
mkdir -p "$OUT"

python evaluation/entropy_analysis.py \
    --model unsloth/Llama-3.1-8B-Instruct \
    --teacher_forcing True \
    --dataset longbench --data_dir narrativeqa --n_samples 150 \
