...
#SBATCH -J hqa_tf_prefill
#SBATCH -p gpu
#SBATCH --gpus 1
#SBATCH -t 00:30:00
#SBATCH -o logs/hotpotqa_tf_prefill_%j.out
#SBATCH -e logs/hotpotqa_tf_prefill_%j.err
...
OUT=./results/entropy_analysis/llma31_8b/longbench/hotpotqa/random/tf_prefill
mkdir -p "$OUT"
