...
#SBATCH -J trec_tf_prefill
#SBATCH -p gpu
#SBATCH --gpus 1
#SBATCH -t 00:30:00
#SBATCH -o logs/trec_tf_prefill_%j.out
#SBATCH -e logs/trec_tf_prefill_%j.err
...
OUT=./results/entropy_analysis/llma31_8b/longbench/trec/random/tf_prefill
mkdir -p "$OUT"
