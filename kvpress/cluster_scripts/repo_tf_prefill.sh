...
#SBATCH -J repo_tf_prefill
#SBATCH -p gpu
#SBATCH --gpus 1
#SBATCH -t 00:30:00
#SBATCH -o logs/repo_tf_prefill_%j.out
#SBATCH -e logs/repo_tf_prefill_%j.err
...
OUT=./results/entropy_analysis/llma31_8b/longbench/repobench-p/random/tf_prefill
mkdir -p "$OUT"
...
python evaluation/entropy_analysis.py \
    ...
    --dataset longbench --data_dir repobench-p --n_samples 150 \
