...
#SBATCH -J trec_sampled_prefill
#SBATCH -p gpu
#SBATCH --gpus 1
#SBATCH -t 06:00:00
#SBATCH -o logs/trec_sampled_prefill_%j.out
#SBATCH -e logs/trec_sampled_prefill_%j.err
...
OUT=./results/entropy_analysis/llma31_8b/longbench/trec/random/sampled_prefill
mkdir -p "$OUT"
