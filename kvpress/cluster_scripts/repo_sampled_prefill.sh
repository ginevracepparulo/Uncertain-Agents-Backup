...
#SBATCH -J repo_sampled_prefill
#SBATCH -p gpu
#SBATCH --gpus 1
#SBATCH -t 06:00:00
#SBATCH -o logs/repo_sampled_prefill_%j.out
#SBATCH -e logs/repo_sampled_prefill_%j.err
...
OUT=./results/entropy_analysis/llma31_8b/longbench/repobench-p/random/sampled_prefill
mkdir -p "$OUT"
...
python evaluation/entropy_analysis.py \
    ...
    --dataset longbench --data_dir repobench-p --n_samples 150 --n_mc_samples 50 \
