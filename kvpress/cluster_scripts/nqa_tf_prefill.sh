...
#SBATCH -J nqa_tf_prefill
#SBATCH -p gpu
#SBATCH --gpus 1
#SBATCH -t 00:30:00
#SBATCH -o logs/nqa_tf_prefill_%j.out
#SBATCH -e logs/nqa_tf_prefill_%j.err
...
OUT=./results/entropy_analysis/llma31_8b/longbench/narrativeqa/random/tf_prefill
mkdir -p "$OUT"
